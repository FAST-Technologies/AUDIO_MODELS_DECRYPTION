...
from .HelpFunction_PyTorch import load_audio_PyTorch, onnx_converter_PyTorch
MY_CONSTANTS = Constants()

class GigaAM_PyTorch(nn.Module):
    """
    ...
    def prepare_wav(self,
        ...
        """
        wav = load_audio_PyTorch(wav_file)
