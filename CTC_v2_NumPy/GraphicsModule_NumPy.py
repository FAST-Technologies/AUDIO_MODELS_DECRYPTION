...
class NumpyGraphicsModule:
    ...
    def plot_fbank(cls,
        ...
        graphics_dir = NumpyGraphicsModule.save_to_directory(graphics_dir)
        ...
        plt.colorbar()
        plt.tight_layout()
        NumpyGraphicsModule.save_to_file(graphics_dir,
                                         title='Plot_Fbank_NumPy')
        plt.show()
        plt.close()
    ...
    def stereo_subploats_graph_V2_0(cls,
        ...
        plt.subplots_adjust(top=0.90,
                            ...
                            wspace=0.1)
        NumpyGraphicsModule.save_to_file(graphics_dir,
                                         title='Plot_Stereo_Subplots_Graph_NumPy')
        plt.show()
        plt.close()
    ...
    def stereo_gridspec_graph_V2_0(cls,
        ...
        gs.update(top=0.85,
                  ...
                  wspace=0.3)
        NumpyGraphicsModule.save_to_file(graphics_dir,
                                         title='Plot_Stereo_GridSpec_Graph_NumPy')
        plt.show()
        plt.close()
    ...
    def plot_waveform(cls,
        ...
        plt.tight_layout()
        NumpyGraphicsModule.save_to_file(graphics_dir,
                                         title='Plot_WaveForm_Graph_NumPy')
        plt.show()
        plt.close()
